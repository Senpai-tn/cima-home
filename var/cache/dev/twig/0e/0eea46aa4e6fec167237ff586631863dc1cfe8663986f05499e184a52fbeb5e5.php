...
class __TwigTemplate_732762571de7552f435221f7ebea6f963214e88fc2f4c306a4a3d1e3c9ccd171 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
", "FrameworkBundle:Form:form_help.html.php", "C:\\wamp64\\www\\Cima@Home\\vendor\\symfony\\framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
