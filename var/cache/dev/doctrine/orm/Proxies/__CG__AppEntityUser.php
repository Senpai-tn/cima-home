...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'series', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
     ...
     * {@inheritDoc}
     */
    public function addSeries(\App\Entity\Serie $series): \App\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function removeSeries(\App\Entity\Serie $series): \App\Entity\User
    {
